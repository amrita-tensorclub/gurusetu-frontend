              ...
              <div className="space-y-4">
                 <details className="group">
                    ...
                    <p className="text-[10px] text-gray-500 mt-2 leading-relaxed">
                       Go to the Profile section from the side menu and click the edit icon on the top right.
                    </p>
                 </details>
                 ...
                 <details className="group">
                    ...
                    <p className="text-[10px] text-gray-500 mt-2 leading-relaxed">
                       Navigate to "My Openings" and click the floating "+" button at the bottom right.
                    </p>
                 </details>
              </div>
           </div>
